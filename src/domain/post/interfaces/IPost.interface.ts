...
export interface IPostService {
  createPost(userId: string, input: CreatePostInput, file: any): Promise<[PostResponseOutput, HttpException]>;
  ...
  updatePostByAuthor(userId: string, updatePostInput: UpdatePostInput, file: any): Promise<[PostResponseOutput, HttpException]>;
